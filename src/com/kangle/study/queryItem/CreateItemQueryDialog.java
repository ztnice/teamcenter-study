...
public class CreateItemQueryDialog extends AbstractAIFDialog implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(btn.equals(onButton)){
			if(itemId.getText()!= null && !"".equals(itemId.getText()) ){
				CreateItemQueryOperation dataSetOpration = new CreateItemQueryOperation(
